...
public class FluxtionPnlCalculator
    ...
    private final MapTuple mapTuple_204 = new MapTuple<>(InstrumentPosMtm::overwriteInstrumentPositionWithSnapshot);
    ...
    public void onEventInternal(Object event) {
        if (event instanceof CallbackEvent typedEvent) {
            handleEvent(typedEvent);
        } else if (event instanceof Signal typedEvent) {
            handleEvent(typedEvent);
        } else if (event instanceof SinkDeregister typedEvent) {
            handleEvent(typedEvent);
        } else if (event instanceof SinkRegistration typedEvent) {
            handleEvent(typedEvent);
        } else if (event instanceof ClockStrategyEvent typedEvent) {
            handleEvent(typedEvent);
        } else if (event instanceof MidPrice typedEvent) {
            handleEvent(typedEvent);
        } else if (event instanceof MtmInstrument typedEvent) {
            handleEvent(typedEvent);
        } else if (event instanceof PositionSnapshot typedEvent) {
            handleEvent(typedEvent);
        } else if (event instanceof Trade typedEvent) {
            handleEvent(typedEvent);
        } else if (event instanceof TradeBatch typedEvent) {
            handleEvent(typedEvent);
        } else {
