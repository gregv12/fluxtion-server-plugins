 ...
 * eventProcessorGenerator version : 9.7.7
 * api version                     : 9.7.7
 * </pre>
 *
...
public class DebugFluxtionPnlCalculator
  ...
  public void handleEvent(InstanceCallbackEvent_0 typedEvent) {
    ...
    if (guardCheck_mapRef2RefFlowFunction_49()) {
      auditInvocation(mapRef2RefFlowFunction_49, "mapRef2RefFlowFunction_49", "map", typedEvent);
    ...
    if (guardCheck_binaryMapToRefFlowFunction_53()) {
      auditInvocation(
          binaryMapToRefFlowFunction_53, "binaryMapToRefFlowFunction_53", "map", typedEvent);
    ...
    if (guardCheck_binaryMapToRefFlowFunction_75()) {
      auditInvocation(
          binaryMapToRefFlowFunction_75, "binaryMapToRefFlowFunction_75", "map", typedEvent);
    ...
    if (guardCheck_mapRef2RefFlowFunction_77()) {
      auditInvocation(mapRef2RefFlowFunction_77, "mapRef2RefFlowFunction_77", "map", typedEvent);
    ...
    if (guardCheck_binaryMapToRefFlowFunction_81()) {
      auditInvocation(
          binaryMapToRefFlowFunction_81, "binaryMapToRefFlowFunction_81", "map", typedEvent);
    ...
    if (guardCheck_mapRef2RefFlowFunction_83()) {
      auditInvocation(mapRef2RefFlowFunction_83, "mapRef2RefFlowFunction_83", "map", typedEvent);
    ...
    if (guardCheck_pushFlowFunction_85()) {
      auditInvocation(pushFlowFunction_85, "pushFlowFunction_85", "push", typedEvent);
    ...
    if (guardCheck_binaryMapToRefFlowFunction_86()) {
      auditInvocation(
          binaryMapToRefFlowFunction_86, "binaryMapToRefFlowFunction_86", "map", typedEvent);
  ...
  public void handleEvent(InstanceCallbackEvent_1 typedEvent) {
    auditEvent(typedEvent);
    //Default, no filter methods
    auditInvocation(callBackNode_112, "callBackNode_112", "onEvent", typedEvent);
  ...
  public void handleEvent(InstanceCallbackEvent_2 typedEvent) {
    auditEvent(typedEvent);
    //Default, no filter methods
    auditInvocation(callBackNode_182, "callBackNode_182", "onEvent", typedEvent);
    isDirty_callBackNode_182 = callBackNode_182.onEvent(typedEvent);
    if (guardCheck_flatMapFlowFunction_30()) {
      auditInvocation(
          flatMapFlowFunction_30, "flatMapFlowFunction_30", "callbackReceived", typedEvent);
  ...
  private void handle_NamedFeedEvent_symbolFeed(NamedFeedEvent typedEvent) {
    auditInvocation(namedFeedTableNode_87, "namedFeedTableNode_87", "tableUpdate", typedEvent);
