...
public class MarketDataBookGenerator {
    ...
    public static MarketDataBook generateRandom(MarketDataBookConfig config) {
        ...
        double bidPrice = roundToDecimalPlaces(midPrice - halfSpread, config.getPricePrecision());
        double askPrice = roundToDecimalPlaces(midPrice + halfSpread, config.getPricePrecision());
